...
void DefFileReader::AddFuncNames(MetaData* pMD, MSTRING sKey, MSTRING sVal) {
    ...
    ADD_FUNC_NAME(GET_NODE_OBJ)
    ADD_FUNC_NAME(QUERY_PROFILE_AND_TDPS)
    ADD_FUNC_NAME(MULTIPLY)
    ADD_FUNC_NAME(ABSOLUTE_VALUE)
    ADD_FUNC_NAME(DIVIDE)
    ADD_FUNC_NAME(QUERY_REVIEWS_BY_PROFILE_IDS)
    ADD_FUNC_NAME(STRING_TO_UNIX_TIME_2)
    ADD_FUNC_NAME(QUERY_REVIEWS_BY_IDENTIFIERS)
    ADD_FUNC_NAME(PERCENTAGE)
    ADD_FUNC_NAME(AVERAGE)
}
