...
std::string processQuery(std::string requestString, nlohmann::json request)
{
    ...
    try
    {
        ...
        // PROCESS END
        // return response;
        return "{\"reqId\": \"1\", \"queries\": [{\"type\": 4, \"val\": \"2018-08-05T12:07:28.607Z\"},{\"type\": 4, \"val\": \"Murtaza was here\"},{\"type\": 0, \"val\": true},{\"type\": 4, \"val\": \"Temperature : 10 - 12 Relative Humidity : 85%\"}]}";
    }
    catch (int ex)
    {
